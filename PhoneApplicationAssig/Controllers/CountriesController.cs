...
namespace PhoneApplicationAssig.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContryId,CountryName,IsActive")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContryId,CountryName,IsActive")] Country country)
        {
            if (ModelState.IsValid)
            {
