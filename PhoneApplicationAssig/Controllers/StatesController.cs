...
namespace PhoneApplicationAssig.Controllers
{
    public class StatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SateId,StateName,CountryId,IsActive")] State state)
        {
            ...
            ViewBag.CountryId = new SelectList(db.Countries, "ContryId", "CountryName", state.CountryId);
            return View(state);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SateId,StateName,CountryId,IsActive")] State state)
        {
            if (ModelState.IsValid)
            {
