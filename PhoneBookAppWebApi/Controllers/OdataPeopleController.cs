...
using PhoneBookAppWebApi.BasicAuthentication;

namespace PhoneBookAppWebApi.Controllers
{
    [EnableCors(origins: "https://localhost:44359", headers: "*", methods: "*")]
    [BasicAuthentication]
    /*
    ...
    */
    public class OdataPeopleController : ODataController
    {
        ...
        // GET: odata/OdataPeople(5)/Address
        [EnableQuery]
